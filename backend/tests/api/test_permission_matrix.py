...
ROUTE_MATRIX: tuple[tuple[str, str, Capability], ...] = (
    ...
    ("GET", "/v1/runs/{run_id}/recommendations", Capability.READ_RECOMMENDATIONS),
    ("GET", "/v1/runs/{run_id}/reports/x", Capability.READ_INFERRED),
    ("GET", "/v1/datasets/dataco/validation", Capability.READ_OBSERVED),

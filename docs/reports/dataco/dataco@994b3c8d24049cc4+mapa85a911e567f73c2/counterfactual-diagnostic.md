...
- base world: `cgr:237943f0bdd4f699`
- simulated world: `none published`
- changes proposed: 1; admitted: 0
...
all 1 proposed change(s) were refused before anything was simulated. The ledger below names what each was checked against. No world is published: an unchanged world would read as 'the change was simulated and had no effect', which is a much stronger claim than 'the change was never admissible'.

## What was refused, and against what

| kind | reason | checked against | detail |
|---|---|---|---|
| `SHIFT_TIMING` | `WOULD_VIOLATE_LAW_TIME` | LAW-TIME, re-checked over the moved bounds | moving evt:3cd104d531e3b363 by -513300.0 second(s) would place it at or before evt:111866b64d4c612c, which the stated graph holds as its antecedent. A hypothetical is not an exemption from LAW-TIME, so the change is refused rather than simulated and flagged. |
...
No quantity was moved that a support envelope could be measured for. This is an absence of measurement, not a finding that the change is supported.
...
No world was published. See above for why.
